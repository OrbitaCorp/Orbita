...
export const LEGAL_CONTENT: Record<LegalKey, { title: string; date: string; sections: { subtitle: string; text: string }[] }> = {
  ...
  // el equipo. Actualizados el 2026-09-16: los Términos § 10 y la Privacidad
  // § 7 ahora cuentan la ventana de 60 días de la baja y exactamente qué se
  // borra y qué se conserva, porque desde esa fecha el borrado definitivo
  // existe de verdad (ver SubscriptionsService.processCancellationWindow).
  //
  // SIGUEN SIN REVISIÓN DE UN ABOGADO: el 2026-09-16 Ale decidió no mandarlos
  // (ítem decision.legales-abogado del tablero de auditoría). Esto cubre lo
  // que el equipo definió y lo que el sistema hace; no reemplaza esa revisión.
  terminos: {
    title: 'Términos y Condiciones de Uso de Órbita',
    date: 'Última actualización: 16 de septiembre, 2026',
    sections: [
      ...
      { subtitle: '6. Suscripción y pagos', text: 'El uso de Órbita está sujeto al pago de una suscripción, cuyo valor y periodicidad vigentes se informan en la Plataforma al momento de la contratación. El pago se realiza mediante débito automático a través de Mercado Pago, autorizado por el Comercio al momento de contratar — Órbita nunca ve ni almacena los datos de la tarjeta.\n\nEl plan no tiene permanencia mínima, salvo que el Comercio opte expresamente por un plan de mayor duración con condiciones especiales, en cuyo caso esas condiciones se informarán y aceptarán por separado. La renovación es automática al vencimiento de cada período, salvo que el Comercio dé de baja su cuenta con anterioridad (ver sección 10).\n\nÓrbita podrá modificar el valor de la suscripción en cualquier momento, notificando al Comercio con razonable anticipación antes de que el nuevo valor entre en vigencia.' },
      ...
      { subtitle: '10. Baja de la cuenta', text: 'El Comercio puede solicitar la baja de su suscripción en cualquier momento desde el panel, o escribiendo a soporte@orbita.site, sin que se le exija trámite adicional injustificado. La baja no genera reintegro de períodos ya abonados, salvo que la normativa aplicable disponga lo contrario.\n\nQué ocurre al dar de baja una cuenta:\n\n• De inmediato: la tienda deja de estar en línea y de ser visible para sus clientes, y Órbita cancela la autorización de débito automático en Mercado Pago. A partir de ese momento no se realiza ningún cobro nuevo.\n• Durante los 60 días siguientes: la cuenta y sus datos se conservan íntegros, y el Comercio puede reactivarla en cualquier momento desde el panel, recuperando su tienda tal como estaba. Para volver a facturar deberá autorizar nuevamente el débito automático, ya que la autorización anterior se canceló al dar de baja. Órbita avisa por correo electrónico 7 días antes de que venza el plazo.\n• Cumplidos los 60 días sin reactivación: la eliminación se vuelve definitiva y se suprimen los datos personales de la cuenta, en los términos de la sección 7 de la Política de Privacidad. Esa supresión no puede revertirse.\n\nÓrbita podrá suspender o dar de baja una cuenta ante incumplimientos graves de estos Términos, uso fraudulento de la Plataforma, o incumplimiento reiterado de la normativa de defensa del consumidor por parte del Comercio, previa notificación cuando sea razonablemente posible.' },
  ...
  privacidad: {
    ...
    sections: [
      ...
      { subtitle: '7. Conservación y supresión de datos', text: 'Conservamos tus datos mientras mantengas tu cuenta activa en Órbita.\n\nSi das de baja tu cuenta tenés 60 días para reactivarla, y durante ese plazo se conserva todo tal como estaba. Cumplido el plazo sin reactivación, la eliminación se vuelve definitiva y suprimimos los datos personales de forma irreversible.\n\nQué se suprime: los datos de las cuentas de acceso al panel y de las cuentas de clientes de la tienda (nombre, correo electrónico, teléfono, DNI, fecha de nacimiento, imagen de perfil y contraseña), las direcciones guardadas, las sesiones abiertas, las conversaciones con la tienda, las reseñas, el registro de correos enviados, las notificaciones y las credenciales de cobro vinculadas. No se reemplazan por datos ficticios: dejan de existir.\n\nQué se conserva, y por qué: los comprobantes de las operaciones realizadas —pedidos, pagos, devoluciones y notas de crédito— se conservan por el plazo que exige la normativa fiscal, que en la República Argentina es de diez años. Esos comprobantes incluyen los datos del comprador que forman parte del comprobante mismo (nombre, contacto y domicilio de entrega), porque sin ellos no cumpliría su función legal. No se usan para ninguna otra finalidad.\n\nSi querés ejercer tus derechos de acceso, rectificación o supresión antes de ese plazo, escribinos a soporte@orbita.site y te indicaremos qué podemos suprimir y qué estamos obligados a conservar.' },
