...
//
// Es la comparación detallada de Base vs Base + Avanzado, a la que se llega
// desde el "Ver más detalle" de las dos tarjetas de precio del home. Antes esa
// comparación era un modal adentro de la sección de precios (ver el comentario
// al principio de Planes.tsx).
//
...
// horizonte cruza por arriba de las tarjetas y las tablas y les come el
// contraste. Quedan solo las estrellas, que sobre negro no molestan.
