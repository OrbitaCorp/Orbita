...
const HALLAZGOS: SeedItem[] = [
  ...
  hallazgo('mp-plan-override-prod', G_INT, 'ALTA', 'El beneficio de bienvenida cobra $15 cada 3 días en producción',
    'deploy/env-vars.yaml tiene MP_PLAN_OVERRIDE: "true" con MP_SUBSCRIPTION_AMOUNT 15 cada 3 días. El propio comentario del archivo dice que es para probar el checkout real y que hay que apagarlo al terminar: con eso prendido, cualquier alta real paga $15 en vez del precio de bienvenida, y ya pasó una vez. Si la prueba terminó, poner "false" antes del próximo deploy. Detectado el 10/09 en la auditoría de trans.secretos. 15/09: Ale decidió dejarlo en true mientras Mateo lo usa para pruebas.',
    ...
    { ruta: 'deploy/env-vars.yaml:26-29 · subscriptions.service.ts#bienvenida' }),
