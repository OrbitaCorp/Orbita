...
const EXCEPCIONES: Record<string, { max: number; motivo: string }> = {
  ...
  'src/support/support.service.ts': { max: 2, motivo: 'Soporte del super admin (adminSummary y adminGet): cross-tenant por diseño, detrás de PlatformAdminGuard en support-admin.controller.ts; todo lo del panel filtra por el businessId del token' },
